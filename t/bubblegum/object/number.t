...
subtest 'test the atan2 method' => sub {
    my $number = 1;
    like $number->atan2(1), qr/0.785398163397448/; # 0.785398163397448
};

can_ok 'Bubblegum::Object::Number', 'cos';
subtest 'test the cos method' => sub {
    my $number = 12;
    like $number->cos, qr/0.843853958732492/; # 0.843853958732492
};
...
subtest 'test the exp method' => sub {
    ...
    $number = 1;
    like $number->exp, qr/2.71828182845905/; # 2.71828182845905

    $number = 1.5;
    like $number->exp, qr/4.48168907033806/; # 4.48168907033806
};
...
subtest 'test the log method' => sub {
    my $number = 12345;
    like $number->log, qr/9.42100640177928/; # 9.42100640177928
};
...
subtest 'test the sin method' => sub {
    my $number = 12345;
    like $number->sin, qr/-0.993771636455681/; # -0.993771636455681
};

can_ok 'Bubblegum::Object::Number', 'sqrt';
subtest 'test the sqrt method' => sub {
    my $number = 12345;
    like $number->sqrt, qr/111.108055513541/; # 111.108055513541
};
